...
namespace ilevus.MoipClient.Implementation
{
    public partial class MoipApiClient
    {
        ...
        public MoipApiClient(IRestClient httpClient = default(IRestClient), string baseUrl = "https://sandbox.moip.com.br/v2")
        {
            var apiAppToken = ConfigurationManager.AppSettings.Get(API_APP_TOKEN);
