	...
	render() {
		if (this.state.editing) {
			if (this.props.type === 'textarea') {
				return (<div className="ilevus-editable-data-input-group input-group input-group-sm">
					<textarea
						ref="data-input"
						rows="3"
						className="ilevus-editable-data-textarea form-control"
				...
				return (<div className="ilevus-editable-data-input-group input-group input-group-sm">
					<input
						ref="data-input"
						type="text"
						className="ilevus-editable-data-input form-control"
						defaultValue={this.state.value}
						onKeyUp={this.onKeyPress} />
				</div>);
			}
		...
		return (<div
			ref="data-view"
			className={"ilevus-editable-data-view "+this.props.className}
