                              ...
                              <div className="ilv-lp-banner-content">
                                  <form onSubmit={this.onSearch}>
                                      <div className="ilv-text-xs-center">
                                          <h1 className="ilv-lp-banner-slogan">Conduza seu sucesso</h1>
                                          <p className="ilv-lp-banner-lead">Encontre os melhores profissionais de coaching e consultoria profissional do mundo.</p>
                                      </div>
                                      <div className="ilv-form-group center-block">
                                          <div className="ilv-input-group">
                                              <input ref="search-term" className="ilv-form-control ilv-form-control-lg ilv-lp-banner-form-control" type="search" placeholder="Pesquise pelo nome, localização ou especialidade..." />
