...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    }).catch((error) => this.setState({ valid: 'ERROR' }))
  }
  render() {
    if (this.state.valid == 'OK') {
      return <Valid />
    }
...
import { PaymentStatementPage } from 'components'
    ...
    <div>
      <Router history={browserHistory}>
        <Route path="/" component={Application}>
          ...
          <Route path="paymentStatement" component={PaymentStatementPage} />
