    ...
    .extend({
        ...
        initialize() {
            this.dispatchToken = this
                .$dispatcher
                .register(this.dispatchCallback.bind(this));
        ...
        refreshStatus(initial) {
            ...
            $.ajax({
                ...
                success(data, status, opts) {
                    ...
                    me.set({
                        "logged": true,
                        "permissions": permClaims.map((claim) => {
                            return claim.value;
                        }),
                        "user": data
                    });
        ...
        sendSystemNotifications(dadosMensagem) {
            ...
            UserStore.on("all", (lista) => {
                ...
                lista.forEach(user => {
                    ...
                    $.ajax({
                        method: "POST",
                        url: me.url + "/SendEmail?assunto=" + assunto + "&mensagem=" + mensagem + '&email=' + email + (dadosMensagem.email
                            ? ('&id=x')
                            : ('&id=' + user.Id)),
                        dataType: 'json',
                        data: {
            ...
            UserStore.dispatch({action: UserStore.ACTION_ALL});
        },
